                ...
                <div className="flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24 ">
                    <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
                        ...
                        <div className="flex gap-5">
                            <button className=' p-2 text-lg font-bold  bg-white hover:bg-slate-400 rounded-md border-2 border-black' onClick={() => router.push('/doctorslogin')}>Doctor</button>
                            <button className=' p-2 text-lg font-bold bg-orange-300 hover:bg-orange-500 rounded-md border-2 border-black' onClick={() => router.push('/patientslogin')}>Patient</button>
                        </div>
                        <p className="mt-2 text-sm text-gray-600">
                            Don&apos;t have an account?
                            <Link
                                href="/patientsregister"
                                title=""
